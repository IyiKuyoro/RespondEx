...
**noContent**: Sends a successful http response with no content. Response will contain a 204 status code and a message body.

| Parameters             | Type   | Description                              | Example                                       |
|------------------------|--------|------------------------------------------|-----------------------------------------------|
| message                | string | The message to be sent with the response | "No resources yet."               |
| res                    | object | The express http response object         |                                               |
| options (_optional_)   | object | Some extra headers                       | { contentType: "application/json" }           |
